...
/* harmony import */ var _shared_utils_pix__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../shared/utils/pix */ "./src/app/shared/utils/pix.ts");
...
/* harmony import */ var _shared_components_card_info_card_info_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../shared/components/card-info/card-info.component */ "./src/app/shared/components/card-info/card-info.component.ts");
...
class CheckoutComponent {
    ...
    copyPix() {
        let pix = _shared_utils_pix__WEBPACK_IMPORTED_MODULE_11__["PIX"].static()
...
CheckoutComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CheckoutComponent, selectors: [["app-checkout"]], decls: 1, vars: 1, consts: [["class", "checkout", 4, "ngIf"], [1, "checkout"], ["text", "Pedido Calculado", 3, "clickedButtonBack"], [1, "card"], [1, "card-title"], ["class", "product", 4, "ngFor", "ngForOf"], [1, "total"], [1, "p-margin-right-auto"], ["title", "Voc\u00EA pode pagar em dinheiro no caixa ou com o PIX", "icon", "moneyCard", "actionText", "Copiar Pix", 3, "description", "clicked"], [1, "action-fixed"], [1, "product"], [1, "product-qty"], [1, "product-name"], ["type", "button", "mat-icon-button", "", 1, "product-btnDetails", 3, "matMenuTriggerFor"], [1, "icon", "icon-more"], [0, "xlink", "href", "#icon-more"], ["menu", "matMenu"], ["mat-menu-item", "", "type", "button", 3, "click"], [1, "icon", "icon-trash"], [0, "xlink", "href", "#icon-trash"], ["class", "additional", 4, "ngFor", "ngForOf"], [1, "additional"], [4, "ngFor", "ngForOf"], [1, "additional-qty"]], template: function CheckoutComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CRC", function() { return CRC; });
/* harmony import */ var _table__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./table */ "./src/app/shared/utils/crc/table.ts");

class CRC {
    static computeCRC(str) {
        let crc = 0xffff;
        let j, i;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "crcTable", function() { return crcTable; });
let crcTable = [
    0x0000,
    0x1021,
    0x2042,
...
/* harmony import */ var _crc_crc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./crc/crc */ "./src/app/shared/utils/crc/crc.ts");
...
class PIX {
    ...
    isUniqueTransaction(is_unique_transaction) {
